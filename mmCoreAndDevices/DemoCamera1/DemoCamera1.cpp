...
using namespace std;
const double CDemoCamera1::nominalPixelSizeUm_ = 1.0;
...
///////////////////////////////////////////////////////////////////////////////
// CDemoCamera1 implementation
// ~~~~~~~~~~~~~~~~~~~~~~~~~~

/**
* CDemoCamera1 constructor.
...
*/
CDemoCamera1::CDemoCamera1() :
   CCameraBase<CDemoCamera1> (),
   ...
   readNoise_(2.5)
{
   ...
   CreateFloatProperty("MaximumExposureMs", exposureMaximum_, false,
         new CPropertyAction(this, &CDemoCamera1::OnMaxExposure),
         true);
}

/**
* CDemoCamera1 destructor.
...
*/
void CDemoCamera1::GetName(char* name) const
{
...
int CDemoCamera1::Initialize()
{
   ...
   // binning
   CPropertyAction *pAct = new CPropertyAction (this, &CDemoCamera1::OnBinning);
   ...
   // pixel type
   pAct = new CPropertyAction (this, &CDemoCamera1::OnPixelType);
   ...
   // Bit depth
   pAct = new CPropertyAction (this, &CDemoCamera1::OnBitDepth);
   ...
   SetPropertyLimits(MM::g_Keyword_Exposure, 0.0, exposureMaximum_);
	...
	for(int ij = 1; ij < 7;++ij)
	{
      ...
      std::string propName = "TestProperty" + os.str();
		pActX = new CPropertyActionEx(this, &CDemoCamera1::OnTestProperty, ij);
   ...
   //pAct = new CPropertyAction(this, &CDemoCamera1::OnSwitch);
   //nRet = CreateIntegerProperty("Switch", 0, false, pAct);
   //SetPropertyLimits("Switch", 8, 1004);
	
	
	// scan mode
   pAct = new CPropertyAction (this, &CDemoCamera1::OnScanMode);
   ...
   // camera temperature
   pAct = new CPropertyAction (this, &CDemoCamera1::OnCCDTemp);
   ...
   pAct = new CPropertyAction(this, &CDemoCamera1::OnShouldRotateImages);
   CreateIntegerProperty("RotateImages", 0, false, pAct);
   AddAllowedValue("RotateImages", "0");
   AddAllowedValue("RotateImages", "1");

   pAct = new CPropertyAction(this, &CDemoCamera1::OnShouldDisplayImageNumber);
   ...
   pAct = new CPropertyAction (this, &CDemoCamera1::OnIsSequenceable);
   ...
   // Camera mode: 
   pAct = new CPropertyAction (this, &CDemoCamera1::OnMode);
   propName = "Mode";
   ...
   pAct = new CPropertyAction(this, &CDemoCamera1::OnPCF);
   ...
   pAct = new CPropertyAction(this, &CDemoCamera1::OnReadNoise);
   ...
   pAct = new CPropertyAction(this, &CDemoCamera1::OnPhotonFlux);
   ...
   pAct = new CPropertyAction(this, &CDemoCamera1::OnCrash);
...
*/
const unsigned char* CDemoCamera1::GetImageBuffer()
{
...
* Required by the MM::Camera API.
*/
unsigned CDemoCamera1::GetImageWidth() const
{
   return img_.Width();
}
...
* Required by the MM::Camera API.
*/
unsigned CDemoCamera1::GetImageHeight() const
{
   return img_.Height();
}
...
* Required by the MM::Camera API.
*/
unsigned CDemoCamera1::GetImageBytesPerPixel() const
{
   return img_.Depth();
} 
...
* Required by the MM::Camera API.
*/
unsigned CDemoCamera1::GetBitDepth() const
{
   return bitDepth_;
}
...
* Required by the MM::Camera API.
*/
long CDemoCamera1::GetImageBufferSize() const
{
...
* @param ySize - height
*/
int CDemoCamera1::SetROI(unsigned x, unsigned y, unsigned xSize, unsigned ySize)
{
   multiROIXs_.clear();
   multiROIYs_.clear();
...
* Required by the MM::Camera API.
*/
int CDemoCamera1::GetROI(unsigned& x, unsigned& y, unsigned& xSize, unsigned& ySize)
{
   x = roiX_;
   y = roiY_;
 ...
 * multiple ROIs.
 */
bool CDemoCamera1::SupportsMultiROI()
{
 ...
 */
bool CDemoCamera1::IsMultiROISet()
{
 ...
 * multiple ROIs.
 */
int CDemoCamera1::GetMultiROICount(unsigned int& count)
{
 ...
 */
int CDemoCamera1::SetMultiROI(const unsigned int* xs, const unsigned int* ys,
 ...
 */
int CDemoCamera1::GetMultiROI(unsigned* xs, unsigned* ys, unsigned* widths,
...
* Required by the MM::Camera API.
*/
double CDemoCamera1::GetExposure() const
{
 ...
 */
double CDemoCamera1::GetSequenceExposure() 
{
...
* Required by the MM::Camera API.
*/
void CDemoCamera1::SetExposure(double exp)
{
...
* Required by the MM::Camera API.
*/
int CDemoCamera1::GetBinning() const
{
   char buf[MM::MaxStrLength];
...
* Required by the MM::Camera API.
*/
int CDemoCamera1::SetBinning(int binF)
{
   return SetProperty(MM::g_Keyword_Binning, CDeviceUtils::ConvertToString(binF));
}

int CDemoCamera1::IsExposureSequenceable(bool& isSequenceable) const
{
   isSequenceable = isSequenceable_;
   return DEVICE_OK;
}

int CDemoCamera1::GetExposureSequenceMaxLength(long& nrEvents) const
{
   if (!isSequenceable_) {
...
int CDemoCamera1::StartExposureSequence()
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
...
int CDemoCamera1::StopExposureSequence()
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
 ...
 */
int CDemoCamera1::ClearExposureSequence()
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
 ...
 */
int CDemoCamera1::AddToExposureSequence(double exposureTime_ms) 
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
...
int CDemoCamera1::SendExposureSequence() const {
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
...
int CDemoCamera1::SetAllowedBinning() 
{
 ...
 */
int CDemoCamera1::StartSequenceAcquisition(double interval)
{
...
*/                                                                        
int CDemoCamera1::StopSequenceAcquisition()                                     
{
   if (!thd_->IsStopped()) {
      thd_->Stop();                                                       
      thd_->wait();                                                       
...
*/
int CDemoCamera1::StartSequenceAcquisition(long numImages, double interval_ms, bool stopOnOverflow)
{
   if (IsCapturing())
 ...
 */
int CDemoCamera1::RunSequenceOnThread(MM::MMTime startTime)
{
   int ret=DEVICE_ERR;
 ...
 */
void CDemoCamera1::OnThreadExiting() throw()
{
   try
   {
...
MySequenceThread::MySequenceThread(CDemoCamera1* pCam)
...
///////////////////////////////////////////////////////////////////////////////
// CDemoCamera1 Action handlers
///////////////////////////////////////////////////////////////////////////////

int CDemoCamera1::OnMaxExposure(MM::PropertyBase* pProp, MM::ActionType eAct)
{
...
int CDemoCamera1::OnTestProperty(MM::PropertyBase* pProp, MM::ActionType eAct, long indexx)
{
   if (eAct == MM::BeforeGet)
   {
...
*/
int CDemoCamera1::OnBinning(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   int ret = DEVICE_ERR;
   switch(eAct)
   {
...
*/
int CDemoCamera1::OnPixelType(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   int ret = DEVICE_ERR;
   switch(eAct)
   {
...
*/
int CDemoCamera1::OnBitDepth(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   int ret = DEVICE_ERR;
   switch(eAct)
   {
...
*/
int CDemoCamera1::OnReadoutTime(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      double readoutMs;
...
int CDemoCamera1::OnDropPixels(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera1::OnFastImage(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera1::OnSaturatePixels(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera1::OnFractionOfPixelsToDropOrSaturate(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      double tvalue = 0;
...
int CDemoCamera1::OnShouldRotateImages(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera1::OnShouldDisplayImageNumber(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera1::OnStripeWidth(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
...
int CDemoCamera1::OnSupportsMultiROI(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera1::OnMultiROIFillValue(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
*/
int CDemoCamera1::OnScanMode(MM::PropertyBase* pProp, MM::ActionType eAct)
{ 
   if (eAct == MM::AfterSet) {
      pProp->Get(scanMode_);
      SetAllowedBinning();
...
int CDemoCamera1::OnCameraCCDXSize(MM::PropertyBase* pProp , MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera1::OnCameraCCDYSize(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera1::OnTriggerDevice(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera1::OnCCDTemp(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      pProp->Set(ccdT_);
...
int CDemoCamera1::OnIsSequenceable(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   std::string val = "Yes";
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera1::OnMode(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   std::string val;
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera1::OnPCF(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      pProp->Set(pcf_);
...
int CDemoCamera1::OnPhotonFlux(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera1::OnReadNoise(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera1::OnCrash(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   AddAllowedValue("SimulateCrash", "");
   AddAllowedValue("SimulateCrash", "Dereference Null Pointer");
   AddAllowedValue("SimulateCrash", "Divide by Zero");
...
///////////////////////////////////////////////////////////////////////////////
// Private CDemoCamera1 methods
///////////////////////////////////////////////////////////////////////////////

/**
* Sync internal image buffer size to the chosen property values.
*/
int CDemoCamera1::ResizeImageBuffer()
{
   char buf[MM::MaxStrLength];
   //int ret = GetProperty(MM::g_Keyword_Binning, buf);
   //if (ret != DEVICE_OK)
...
void CDemoCamera1::GenerateEmptyImage(ImgBuffer& img)
{
   MMThreadGuard g(imgPixelsLock_);
...
* 2. Gaussian noise
*/
void CDemoCamera1::GenerateSyntheticImage(ImgBuffer& img, double exp)
{
...
bool CDemoCamera1::GenerateColorTestPattern(ImgBuffer& img)
{
...
void CDemoCamera1::TestResourceLocking(const bool recurse)
{
   if(recurse)
...
*/
void CDemoCamera1::AddBackgroundAndNoise(ImgBuffer& img, double mean, double stdDev)
{ 
	char buf[MM::MaxStrLength];
   GetProperty(MM::g_Keyword_PixelType, buf);
	std::string pixelType(buf);
...
* Assumes QE of 100%
*/
void CDemoCamera1::AddSignal(ImgBuffer& img, double photonFlux, double exp, double cf)
{ 
	char buf[MM::MaxStrLength];
   GetProperty(MM::g_Keyword_PixelType, buf);
	std::string pixelType(buf);
 ...
 */
double CDemoCamera1::GaussDistributedValue(double mean, double std)
{
   double s = 2;
...
int CDemoCamera1::RegisterImgManipulatorCallBack(ImgManipulator* imgManpl)
{
   imgManpl_ = imgManpl;
   return DEVICE_OK;
}
   ...
   if (!pHub)
   {
      ...
      for (;;)
      {
         ...
         if (0 < strlen(deviceName)) 
         {
            ...
            if (cHub == pHub)
            {
               demoCamera_ = (CDemoCamera1*) camera;
