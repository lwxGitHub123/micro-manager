...
class CDemoCamera1 : public CCameraBase<CDemoCamera1>  
{
public:
   CDemoCamera1();
   ~CDemoCamera1();
...
{
   friend class CDemoCamera1;
   enum { default_numImages=1, default_intervalMS = 100 };
   public:
      MySequenceThread(CDemoCamera1* pCam);
      ~MySequenceThread();
      void Stop();
