...
//                License text is included with the source distribution.
//
#ifndef _CPCO_CAMERA1_H_
#define _CPCO_CAMERA1_H_
...
//
class CPCO_Camera1 : public CCameraBase<CPCO_Camera1>
{
public:
  CPCO_Camera1();
  ~CPCO_Camera1();
...
private:
  ...
  {
  public:
    SequenceThread(CPCO_Camera1* pCam) : stop_(false), numImages_(0) {camera_ = pCam;}
    ~SequenceThread() {}
