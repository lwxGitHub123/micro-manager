...
//                XY Stage
//
// AUTHOR:        Steven Fletcher, derived from Corvus adapter written by Johan Henriksson, mahogny@areta.org, derived from M�rzhauser adapter
