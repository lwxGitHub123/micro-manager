...
using namespace std;
const double CDemoCamera3::nominalPixelSizeUm_ = 1.0;
...
///////////////////////////////////////////////////////////////////////////////
// CDemoCamera3 implementation
// ~~~~~~~~~~~~~~~~~~~~~~~~~~

/**
* CDemoCamera3 constructor.
...
int CDemoCamera3::Initialize()
{
   ...
   // binning
   CPropertyAction *pAct = new CPropertyAction (this, &CDemoCamera3::OnBinning);
   ...
   // pixel type
   pAct = new CPropertyAction (this, &CDemoCamera3::OnPixelType);
   ...
   SetPropertyLimits(MM::g_Keyword_Exposure, 0.0, exposureMaximum_);
	...
	for(int ij = 1; ij < 7;++ij)
	{
      ...
      std::string propName = "TestProperty" + os.str();
		pActX = new CPropertyActionEx(this, &CDemoCamera3::OnTestProperty, ij);
   ...
   //pAct = new CPropertyAction(this, &CDemoCamera3::OnSwitch);
   //nRet = CreateIntegerProperty("Switch", 0, false, pAct);
   //SetPropertyLimits("Switch", 8, 1004);
	
	
	// scan mode
   pAct = new CPropertyAction (this, &CDemoCamera3::OnScanMode);
   ...
   // camera temperature
   pAct = new CPropertyAction (this, &CDemoCamera3::OnCCDTemp);
   ...
   pAct = new CPropertyAction(this, &CDemoCamera3::OnShouldRotateImages);
   CreateIntegerProperty("RotateImages", 0, false, pAct);
   AddAllowedValue("RotateImages", "0");
   AddAllowedValue("RotateImages", "1");

   pAct = new CPropertyAction(this, &CDemoCamera3::OnShouldDisplayImageNumber);
   ...
   pAct = new CPropertyAction (this, &CDemoCamera3::OnIsSequenceable);
   ...
   // Camera mode: 
   pAct = new CPropertyAction (this, &CDemoCamera3::OnMode);
   propName = "Mode";
   ...
   pAct = new CPropertyAction(this, &CDemoCamera3::OnPCF);
   ...
   pAct = new CPropertyAction(this, &CDemoCamera3::OnReadNoise);
   ...
   pAct = new CPropertyAction(this, &CDemoCamera3::OnPhotonFlux);
   ...
   pAct = new CPropertyAction(this, &CDemoCamera3::OnCrash);
...
* Required by the MM::Camera API.
*/
unsigned CDemoCamera3::GetImageHeight() const
{
   return img_.Height();
}
...
* Required by the MM::Camera API.
*/
unsigned CDemoCamera3::GetImageBytesPerPixel() const
{
   return img_.Depth();
} 
...
* Required by the MM::Camera API.
*/
unsigned CDemoCamera3::GetBitDepth() const
{
   return bitDepth_;
}
...
* Required by the MM::Camera API.
*/
long CDemoCamera3::GetImageBufferSize() const
{
...
* Required by the MM::Camera API.
*/
int CDemoCamera3::GetROI(unsigned& x, unsigned& y, unsigned& xSize, unsigned& ySize)
{
   x = roiX_;
   y = roiY_;
 ...
 */
bool CDemoCamera3::IsMultiROISet()
{
 ...
 * multiple ROIs.
 */
int CDemoCamera3::GetMultiROICount(unsigned int& count)
{
 ...
 */
int CDemoCamera3::SetMultiROI(const unsigned int* xs, const unsigned int* ys,
 ...
 */
int CDemoCamera3::GetMultiROI(unsigned* xs, unsigned* ys, unsigned* widths,
 ...
 */
double CDemoCamera3::GetSequenceExposure() 
{
...
* Required by the MM::Camera API.
*/
void CDemoCamera3::SetExposure(double exp)
{
...
* Required by the MM::Camera API.
*/
int CDemoCamera3::GetBinning() const
{
   char buf[MM::MaxStrLength];
...
* Required by the MM::Camera API.
*/
int CDemoCamera3::SetBinning(int binF)
{
   return SetProperty(MM::g_Keyword_Binning, CDeviceUtils::ConvertToString(binF));
}

int CDemoCamera3::IsExposureSequenceable(bool& isSequenceable) const
{
   isSequenceable = isSequenceable_;
   return DEVICE_OK;
}

int CDemoCamera3::GetExposureSequenceMaxLength(long& nrEvents) const
{
   if (!isSequenceable_) {
...
int CDemoCamera3::StartExposureSequence()
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
...
int CDemoCamera3::StopExposureSequence()
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
 ...
 */
int CDemoCamera3::ClearExposureSequence()
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
 ...
 */
int CDemoCamera3::AddToExposureSequence(double exposureTime_ms) 
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
...
int CDemoCamera3::SendExposureSequence() const {
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
...
int CDemoCamera3::SetAllowedBinning() 
{
 ...
 */
int CDemoCamera3::StartSequenceAcquisition(double interval)
{
...
*/                                                                        
int CDemoCamera3::StopSequenceAcquisition()                                     
{
   if (!thd_->IsStopped()) {
      thd_->Stop();                                                       
      thd_->wait();                                                       
...
*/
int CDemoCamera3::StartSequenceAcquisition(long numImages, double interval_ms, bool stopOnOverflow)
{
   if (IsCapturing())
 ...
 */
int CDemoCamera3::RunSequenceOnThread(MM::MMTime startTime)
{
   int ret=DEVICE_ERR;
 ...
 */
void CDemoCamera3::OnThreadExiting() throw()
{
   try
   {
...
MySequenceThread::MySequenceThread(CDemoCamera3* pCam)
...
///////////////////////////////////////////////////////////////////////////////
// CDemoCamera3 Action handlers
///////////////////////////////////////////////////////////////////////////////

int CDemoCamera3::OnMaxExposure(MM::PropertyBase* pProp, MM::ActionType eAct)
{
...
int CDemoCamera3::OnTestProperty(MM::PropertyBase* pProp, MM::ActionType eAct, long indexx)
{
   if (eAct == MM::BeforeGet)
   {
...
*/
int CDemoCamera3::OnBinning(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   int ret = DEVICE_ERR;
   switch(eAct)
   {
...
*/
int CDemoCamera3::OnPixelType(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   int ret = DEVICE_ERR;
   switch(eAct)
   {
...
*/
int CDemoCamera3::OnBitDepth(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   int ret = DEVICE_ERR;
   switch(eAct)
   {
...
*/
int CDemoCamera3::OnReadoutTime(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      double readoutMs;
...
int CDemoCamera3::OnDropPixels(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera3::OnFastImage(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera3::OnSaturatePixels(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera3::OnFractionOfPixelsToDropOrSaturate(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      double tvalue = 0;
...
int CDemoCamera3::OnShouldRotateImages(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera3::OnShouldDisplayImageNumber(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera3::OnStripeWidth(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
...
int CDemoCamera3::OnSupportsMultiROI(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CDemoCamera3::OnMultiROIFillValue(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
*/
int CDemoCamera3::OnScanMode(MM::PropertyBase* pProp, MM::ActionType eAct)
{ 
   if (eAct == MM::AfterSet) {
      pProp->Get(scanMode_);
      SetAllowedBinning();
...
int CDemoCamera3::OnCameraCCDXSize(MM::PropertyBase* pProp , MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera3::OnCameraCCDYSize(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera3::OnTriggerDevice(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera3::OnCCDTemp(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      pProp->Set(ccdT_);
...
int CDemoCamera3::OnIsSequenceable(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   std::string val = "Yes";
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera3::OnMode(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   std::string val;
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera3::OnPCF(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      pProp->Set(pcf_);
...
int CDemoCamera3::OnPhotonFlux(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera3::OnReadNoise(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CDemoCamera3::OnCrash(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   AddAllowedValue("SimulateCrash", "");
   AddAllowedValue("SimulateCrash", "Dereference Null Pointer");
   AddAllowedValue("SimulateCrash", "Divide by Zero");
...
void CDemoCamera3::GenerateEmptyImage(ImgBuffer& img)
{
   MMThreadGuard g(imgPixelsLock_);
...
* 2. Gaussian noise
*/
void CDemoCamera3::GenerateSyntheticImage(ImgBuffer& img, double exp)
{
...
bool CDemoCamera3::GenerateColorTestPattern(ImgBuffer& img)
{
...
void CDemoCamera3::TestResourceLocking(const bool recurse)
{
   if(recurse)
...
*/
void CDemoCamera3::AddBackgroundAndNoise(ImgBuffer& img, double mean, double stdDev)
{ 
	char buf[MM::MaxStrLength];
   GetProperty(MM::g_Keyword_PixelType, buf);
	std::string pixelType(buf);
...
* Assumes QE of 100%
*/
void CDemoCamera3::AddSignal(ImgBuffer& img, double photonFlux, double exp, double cf)
{ 
	char buf[MM::MaxStrLength];
   GetProperty(MM::g_Keyword_PixelType, buf);
	std::string pixelType(buf);
 ...
 */
double CDemoCamera3::GaussDistributedValue(double mean, double std)
{
   double s = 2;
...
int CDemoCamera3::RegisterImgManipulatorCallBack(ImgManipulator* imgManpl)
{
   imgManpl_ = imgManpl;
   return DEVICE_OK;
}
   ...
   if (!pHub)
   {
      ...
      for (;;)
      {
         ...
         if (0 < strlen(deviceName)) 
         {
            ...
            if (cHub == pHub)
            {
               demoCamera_ = (CDemoCamera3*) camera;
