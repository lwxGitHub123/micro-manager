...
class CDemoCamera3 : public CCameraBase<CDemoCamera3>  
{
public:
   CDemoCamera3();
   ~CDemoCamera3();
...
{
   friend class CDemoCamera3;
   enum { default_numImages=1, default_intervalMS = 100 };
   public:
      MySequenceThread(CDemoCamera3* pCam);
      ~MySequenceThread();
      void Stop();
