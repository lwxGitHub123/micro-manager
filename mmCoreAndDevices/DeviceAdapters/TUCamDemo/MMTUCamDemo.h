...
#ifndef _MMTUCAMDEMO_H_
#define _MMTUCAMDEMO_H_
...
class CTUCamDemoThread;

class CMMTUCamDemo : public CCameraBase<CMMTUCamDemo>  
{
public:
    CMMTUCamDemo();
    ~CMMTUCamDemo();
...
private:
    ...
    int InitTUCamDemoApi();
    int UninitTUCamDemoApi();
...
class CTUCamDemoThread : public MMDeviceThreadBase
{
   friend class CMMTUCamDemo;
   enum { default_numImages=1, default_intervalMS = 100 };
   public:
      CTUCamDemoThread(CMMTUCamDemo* pCam);
      ~CTUCamDemoThread();
      void Stop();
