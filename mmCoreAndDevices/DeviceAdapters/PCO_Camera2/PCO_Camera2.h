...
//                License text is included with the source distribution.
//
#ifndef _CPCO_CAMERA2_H_
#define _CPCO_CAMERA2_H_
...
//
class CPCO_Camera2 : public CCameraBase<CPCO_Camera2>
{
public:
  CPCO_Camera2();
  ~CPCO_Camera2();
...
private:
  ...
  {
  public:
    SequenceThread(CPCO_Camera2* pCam) : stop_(false), numImages_(0) {camera_ = pCam;}
    ~SequenceThread() {}
