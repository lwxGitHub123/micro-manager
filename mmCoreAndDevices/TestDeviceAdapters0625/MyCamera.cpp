...
using namespace std;
const double CMyCamera::nominalPixelSizeUm_ = 1.0;
...
{
   RegisterDevice(g_CameraDeviceName, MM::CameraDevice, "My camera");
   RegisterDevice(g_WheelDeviceName, MM::StateDevice, "My filter wheel");
   RegisterDevice(g_StateDeviceName, MM::StateDevice, "My State Device");
   RegisterDevice(g_ObjectiveDeviceName, MM::StateDevice, "My objective turret");
   RegisterDevice(g_StageDeviceName, MM::StageDevice, "My stage");
   RegisterDevice(g_XYStageDeviceName, MM::XYStageDevice, "My XY stage");
   RegisterDevice(g_LightPathDeviceName, MM::StateDevice, "My light path");
   RegisterDevice(g_AutoFocusDeviceName, MM::AutoFocusDevice, "My auto focus");
   RegisterDevice(g_ShutterDeviceName, MM::ShutterDevice, "My shutter");
   RegisterDevice(g_DADeviceName, MM::SignalIODevice, "My DA");
   RegisterDevice(g_DA2DeviceName, MM::SignalIODevice, "My DA-2");
   RegisterDevice(g_MagnifierDeviceName, MM::MagnifierDevice, "My Optovar");
   RegisterDevice(g_GalvoDeviceName, MM::GalvoDevice, "My Galvo");
...
///////////////////////////////////////////////////////////////////////////////
// CMyCamera implementation
// ~~~~~~~~~~~~~~~~~~~~~~~~~~

/**
* CMyCamera constructor.
   ...
   readNoise_(2.5)
{
   ...
   CreateFloatProperty("MaximumExposureMs", exposureMaximum_, false,
         new CPropertyAction(this, &CMyCamera::OnMaxExposure),
         true);
}

/**
* CMyCamera destructor.
...
*/
void CMyCamera::GetName(char* name) const
{
...
int CMyCamera::Initialize()
{
   ...
   // binning
   CPropertyAction *pAct = new CPropertyAction (this, &CMyCamera::OnBinning);
   ...
   // pixel type
   pAct = new CPropertyAction (this, &CMyCamera::OnPixelType);
   ...
   // Bit depth
   pAct = new CPropertyAction (this, &CMyCamera::OnBitDepth);
   ...
   SetPropertyLimits(MM::g_Keyword_Exposure, 0.0, exposureMaximum_);
	...
	for(int ij = 1; ij < 7;++ij)
	{
      ...
      std::string propName = "TestProperty" + os.str();
		pActX = new CPropertyActionEx(this, &CMyCamera::OnTestProperty, ij);
   ...
   //pAct = new CPropertyAction(this, &CMyCamera::OnSwitch);
   //nRet = CreateIntegerProperty("Switch", 0, false, pAct);
   //SetPropertyLimits("Switch", 8, 1004);
	
	
	// scan mode
   pAct = new CPropertyAction (this, &CMyCamera::OnScanMode);
   ...
   // camera temperature
   pAct = new CPropertyAction (this, &CMyCamera::OnCCDTemp);
   ...
   pAct = new CPropertyAction(this, &CMyCamera::OnShouldRotateImages);
   CreateIntegerProperty("RotateImages", 0, false, pAct);
   AddAllowedValue("RotateImages", "0");
   AddAllowedValue("RotateImages", "1");

   pAct = new CPropertyAction(this, &CMyCamera::OnShouldDisplayImageNumber);
   ...
   pAct = new CPropertyAction (this, &CMyCamera::OnIsSequenceable);
   ...
   // Camera mode: 
   pAct = new CPropertyAction (this, &CMyCamera::OnMode);
   propName = "Mode";
   ...
   pAct = new CPropertyAction(this, &CMyCamera::OnPCF);
   ...
   pAct = new CPropertyAction(this, &CMyCamera::OnReadNoise);
   ...
   pAct = new CPropertyAction(this, &CMyCamera::OnPhotonFlux);
   ...
   pAct = new CPropertyAction(this, &CMyCamera::OnCrash);
...
*/
const unsigned char* CMyCamera::GetImageBuffer()
{
...
* Required by the MM::Camera API.
*/
unsigned CMyCamera::GetImageWidth() const
{
   return img_.Width();
}
...
* Required by the MM::Camera API.
*/
unsigned CMyCamera::GetImageHeight() const
{
   return img_.Height();
}
...
* Required by the MM::Camera API.
*/
unsigned CMyCamera::GetImageBytesPerPixel() const
{
   return img_.Depth();
} 
...
* Required by the MM::Camera API.
*/
unsigned CMyCamera::GetBitDepth() const
{
   return bitDepth_;
}
...
* Required by the MM::Camera API.
*/
long CMyCamera::GetImageBufferSize() const
{
...
* @param ySize - height
*/
int CMyCamera::SetROI(unsigned x, unsigned y, unsigned xSize, unsigned ySize)
{
   multiROIXs_.clear();
   multiROIYs_.clear();
...
* Required by the MM::Camera API.
*/
int CMyCamera::GetROI(unsigned& x, unsigned& y, unsigned& xSize, unsigned& ySize)
{
   x = roiX_;
   y = roiY_;
 ...
 * multiple ROIs.
 */
bool CMyCamera::SupportsMultiROI()
{
 ...
 * multiple ROIs.
 */
int CMyCamera::GetMultiROICount(unsigned int& count)
{
 ...
 */
int CMyCamera::SetMultiROI(const unsigned int* xs, const unsigned int* ys,
 ...
 */
int CMyCamera::GetMultiROI(unsigned* xs, unsigned* ys, unsigned* widths,
...
* Required by the MM::Camera API.
*/
double CMyCamera::GetExposure() const
{
 ...
 */
double CMyCamera::GetSequenceExposure() 
{
...
* Required by the MM::Camera API.
*/
void CMyCamera::SetExposure(double exp)
{
...
* Required by the MM::Camera API.
*/
int CMyCamera::GetBinning() const
{
   char buf[MM::MaxStrLength];
...
* Required by the MM::Camera API.
*/
int CMyCamera::SetBinning(int binF)
{
   return SetProperty(MM::g_Keyword_Binning, CDeviceUtils::ConvertToString(binF));
}

int CMyCamera::IsExposureSequenceable(bool& isSequenceable) const
{
   isSequenceable = isSequenceable_;
   return DEVICE_OK;
}

int CMyCamera::GetExposureSequenceMaxLength(long& nrEvents) const
{
   if (!isSequenceable_) {
...
int CMyCamera::StartExposureSequence()
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
...
int CMyCamera::StopExposureSequence()
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
 ...
 */
int CMyCamera::ClearExposureSequence()
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
 ...
 */
int CMyCamera::AddToExposureSequence(double exposureTime_ms) 
{
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
...
int CMyCamera::SendExposureSequence() const {
   if (!isSequenceable_) {
      return DEVICE_UNSUPPORTED_COMMAND;
   }
...
int CMyCamera::SetAllowedBinning() 
{
 ...
 */
int CMyCamera::StartSequenceAcquisition(double interval)
{
...
*/                                                                        
int CMyCamera::StopSequenceAcquisition()                                     
{
   if (!thd_->IsStopped()) {
      thd_->Stop();                                                       
      thd_->wait();                                                       
...
*/
int CMyCamera::StartSequenceAcquisition(long numImages, double interval_ms, bool stopOnOverflow)
{
   if (IsCapturing())
 ...
 */
int CMyCamera::RunSequenceOnThread(MM::MMTime startTime)
{
   int ret=DEVICE_ERR;
 ...
 */
void CMyCamera::OnThreadExiting() throw()
{
   try
   {
...
MySequenceThread::MySequenceThread(CMyCamera* pCam)
...
///////////////////////////////////////////////////////////////////////////////
// CMyCamera Action handlers
///////////////////////////////////////////////////////////////////////////////

int CMyCamera::OnMaxExposure(MM::PropertyBase* pProp, MM::ActionType eAct)
{
...
int CMyCamera::OnTestProperty(MM::PropertyBase* pProp, MM::ActionType eAct, long indexx)
{
   if (eAct == MM::BeforeGet)
   {
...
*/
int CMyCamera::OnBinning(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   int ret = DEVICE_ERR;
   switch(eAct)
   {
...
*/
int CMyCamera::OnPixelType(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   int ret = DEVICE_ERR;
   switch(eAct)
   {
...
*/
int CMyCamera::OnBitDepth(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   int ret = DEVICE_ERR;
   switch(eAct)
   {
...
*/
int CMyCamera::OnReadoutTime(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      double readoutMs;
...
int CMyCamera::OnDropPixels(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CMyCamera::OnFastImage(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CMyCamera::OnSaturatePixels(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CMyCamera::OnFractionOfPixelsToDropOrSaturate(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      double tvalue = 0;
...
int CMyCamera::OnShouldRotateImages(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CMyCamera::OnShouldDisplayImageNumber(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CMyCamera::OnStripeWidth(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
...
int CMyCamera::OnSupportsMultiROI(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
int CMyCamera::OnMultiROIFillValue(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::AfterSet)
   {
      long tvalue = 0;
...
*/
int CMyCamera::OnScanMode(MM::PropertyBase* pProp, MM::ActionType eAct)
{ 
   if (eAct == MM::AfterSet) {
      pProp->Get(scanMode_);
      SetAllowedBinning();
...
int CMyCamera::OnCameraCCDXSize(MM::PropertyBase* pProp , MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CMyCamera::OnCameraCCDYSize(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CMyCamera::OnTriggerDevice(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CMyCamera::OnCCDTemp(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      pProp->Set(ccdT_);
...
int CMyCamera::OnIsSequenceable(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   std::string val = "Yes";
   if (eAct == MM::BeforeGet)
   {
...
int CMyCamera::OnMode(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   std::string val;
   if (eAct == MM::BeforeGet)
   {
...
int CMyCamera::OnPCF(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      pProp->Set(pcf_);
...
int CMyCamera::OnPhotonFlux(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CMyCamera::OnReadNoise(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
int CMyCamera::OnCrash(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   AddAllowedValue("SimulateCrash", "");
   AddAllowedValue("SimulateCrash", "Dereference Null Pointer");
   AddAllowedValue("SimulateCrash", "Divide by Zero");
...
///////////////////////////////////////////////////////////////////////////////
// Private CMyCamera methods
///////////////////////////////////////////////////////////////////////////////

/**
* Sync internal image buffer size to the chosen property values.
*/
int CMyCamera::ResizeImageBuffer()
{
   char buf[MM::MaxStrLength];
   //int ret = GetProperty(MM::g_Keyword_Binning, buf);
   //if (ret != DEVICE_OK)
...
void CMyCamera::GenerateEmptyImage(ImgBuffer& img)
{
   MMThreadGuard g(imgPixelsLock_);
...
* 2. Gaussian noise
*/
void CMyCamera::GenerateSyntheticImage(ImgBuffer& img, double exp)
{
...
bool CMyCamera::GenerateColorTestPattern(ImgBuffer& img)
{
...
void CMyCamera::TestResourceLocking(const bool recurse)
{
   if(recurse)
...
*/
void CMyCamera::AddBackgroundAndNoise(ImgBuffer& img, double mean, double stdDev)
{ 
	char buf[MM::MaxStrLength];
   GetProperty(MM::g_Keyword_PixelType, buf);
	std::string pixelType(buf);
...
* Assumes QE of 100%
*/
void CMyCamera::AddSignal(ImgBuffer& img, double photonFlux, double exp, double cf)
{ 
	char buf[MM::MaxStrLength];
   GetProperty(MM::g_Keyword_PixelType, buf);
	std::string pixelType(buf);
 ...
 */
double CMyCamera::GaussDistributedValue(double mean, double std)
{
   double s = 2;
...
int CMyCamera::RegisterImgManipulatorCallBack(ImgManipulator* imgManpl)
{
   imgManpl_ = imgManpl;
   return DEVICE_OK;
}
