...
public class Panel extends JPanel {
    ...
    public static Panel createFromMigLayout(final String layout, final String cols, final String rows) {
    ...
    public static void setDefaultMigLayout(final String layout, final String cols, final String rows) {
